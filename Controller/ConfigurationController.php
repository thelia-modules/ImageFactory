...
namespace ImageFactory\Controller;
 ...
 * @package ImageFactory\Controller
...
class ConfigurationController extends BaseAdminController
{
    ...
    {
        if (null !== $response = $this->checkAuth([], 'ImageFactory', AccessManager::VIEW)) {
            return $response;
        }

        $params = array_merge($params, [
            'factories' => ImageFactoryQuery::create()
                ->joinWithI18n($this->getRequest()->getSession()->getLang()->getLocale())
                ->find(),
            'module_code' => 'ImageFactory'
        ]);

        return $this->render("image-factory/configuration", $params);
    }
